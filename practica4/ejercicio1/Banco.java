...
El metodo es tan ineficiente ya que implementa unos for anidados dando un tiempo de ejecucion de orden 0(N^2)

c.- ¿En qué se diferencia procesarMovimientosOptimizado? Observe las operaciones que se
realizan para cada consulta.
El metodo optimizado en cambio, hace uso de dos for al igual que el anterior metodo pero con la diferencia de que estos no estan
anidados dando como resultado un tiempo de ejecucion de orden O(N)
*/
